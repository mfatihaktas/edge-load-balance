...
def sim_rr(num_req_to_finish, ro, num_sim, write_to_json=False):
	log(DEBUG, "started")
...
def sim_ET_for_single_m():
	...
	d, p = 2, 10
	ET, std_T, EW, std_W = sim_rr(num_req_to_finish=sim_config.num_req_to_finish, ro=sim_config.ro, num_sim=1, write_to_json=True)
...
def sim_ET_vs_ro():
	...
	sim_w_ro = lambda ro : sim_rr(num_req_to_finish=sim_config.num_req_to_finish, ro=ro, num_sim=sim_config.num_sim, write_to_json=True)
	sim_utils.sim_common_ET_vs_ro('rr', sim_w_ro)
