...
def sim_probe_iidClusters_wPodC(d, inter_probe_time_rv, num_probe=None, num_sim=100, sim_time=1000):
...
def sim_cost_wrt_d():
	...
	for d in [1, 2, 3, *np.linspace(5, num_cluster, 4)]:
		...
		cost = sim_probe_iidClusters_wPodC(d, inter_probe_time_rv, num_probe, num_sim, sim_time)
