...
if [ $1 = 's' ]; then
  ...
  $PY -u client.py --i=0 --d=2 --inter_probe_num_reqs=10 --mean_inter_gen_time=0.1 --num_reqs_to_finish=10000 --mid_addr_m='{"m0": ["10.0.0.0", "null"], "m1": ["10.0.0.1", "null"]}' --dashboard_server_ip='10.0.3.0'
elif [ $1 = 'cm' ]; then
  ...
  $PY -u client.py --i=$2 --d=2 --inter_probe_num_reqs=10 --mean_inter_gen_time=0.5 --num_reqs_to_finish=100000 --mid_addr_m='{"m0": ["127.0.0.1", '$3'], "m1": ["127.0.0.1", '$4']}'
elif [ $1 = 'm' ]; then
