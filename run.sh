...
if [ $1 = 's' ]; then
  ...
  M0_IP=
  DASHBOARD_SERVER_IP=
  $PY -u client.py --i=$2 --mean_inter_gen_time=0.12 --num_reqs_to_finish=100000 --mid_addr_m='{"'$M0_IP'": ["10.101.185.226", "null"]}' --dashboard_server_addr='["'$DASHBOARD_SERVER_IP'", "null"]'
elif [ $1 = 'cm2' ]; then
  ...
  M1_IP=
  DASHBOARD_SERVER_IP=
  $PY -u client.py --i=$2 --d=2 --inter_probe_num_reqs=20 --mean_inter_gen_time=0.1 --num_reqs_to_finish=100000 --mid_addr_m='{"m0": ["'$M0_IP'", "null"], "m1": ["'$M1_IP'", "null"]}' --dashboard_server_addr='["'$DASHBOARD_SERVER_IP'", "null"]'
elif [ $1 = 'm' ]; then
